...
const LinkedInScrapingEnhanced = () => {
    ...
    <div className="bg-gray-800 rounded-lg p-8">
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          placeholder="Paste the Sales Navigator search URL to scrape leads from..."
      ...
      >
        ...
        {isProcessing ? 'Processing...' : 'Start LinkedIn Scraping'}
      </button>
    </div>
  );
};

export default LinkedInScrapingEnhanced;